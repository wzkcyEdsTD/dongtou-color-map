 ...
 * @LastEditTime: 2020-06-22 16:29:11
 * @LastEditors: eds
 * @Description:
...
const CONFIG_DEV = {
  ...
  LOCAL_HOST: "http://10.36.213.3/server/rest/services",
...
const MAP_INIT_OPTION = {
  center: [121.14190184915255, 27.835794680572487],
  zoom: 14,
};
//  图钉
...
//  洞头大数据底图
const LAYER = `${CONFIG_DEV.LOCAL_HOST}/Hosted/dt_dsjdt/VectorTileServer`;
//  标准版底图
const STANDARD = `${CONFIG_DEV.LOCAL_HOST}/Hosted/BZBGCS2000/VectorTileServer`;
//  二维影像底图
